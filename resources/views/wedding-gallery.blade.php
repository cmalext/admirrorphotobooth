  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500">
        <img src="image/wedding1.jpg" alt="Wedding Celebration 1" class="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-500">
        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div class="p-6 text-white w-full">
            <h3 class="text-lg font-semibold mb-2">Beautiful Wedding Moments</h3>
            <p class="text-sm opacity-90">Capturing love and joy</p>
            <div class="flex items-center mt-3">
              <i class="fas fa-heart text-red-400 mr-2"></i>
              <span class="text-sm">Wedding Celebration</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Wedding Photo 2 -->
      <div class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500">
        <img src="image/wedding2.jpg" alt="Wedding Celebration 2" class="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-500">
        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div class="p-6 text-white w-full">
            <h3 class="text-lg font-semibold mb-2">Elegant Wedding Photos</h3>
            <p class="text-sm opacity-90">Timeless memories created</p>
            <div class="flex items-center mt-3">
              <i class="fas fa-heart text-red-400 mr-2"></i>
              <span class="text-sm">Wedding Celebration</span>
            </div>
      ...
      <!-- Wedding Photo 3 -->
      <div class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500">
        <img src="image/wedding3.jpg" alt="Wedding Celebration 3" class="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-500">
        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div class="p-6 text-white w-full">
            <h3 class="text-lg font-semibold mb-2">Magical Wedding Day</h3>
            <p class="text-sm opacity-90">Unforgettable moments</p>
            <div class="flex items-center mt-3">
              <i class="fas fa-heart text-red-400 mr-2"></i>
              <span class="text-sm">Wedding Celebration</span>
            </div>
      ...
      <!-- Wedding Photo 4 -->
      <div class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500">
        <img src="image/wedding4.jpg" alt="Wedding Celebration 4" class="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-500">
        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div class="p-6 text-white w-full">
            <h3 class="text-lg font-semibold mb-2">Romantic Wedding Photos</h3>
            <p class="text-sm opacity-90">Love captured perfectly</p>
            <div class="flex items-center mt-3">
              <i class="fas fa-heart text-red-400 mr-2"></i>
              <span class="text-sm">Wedding Celebration</span>
            </div>
      ...
      <!-- Wedding Photo 5 -->
      <div class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500">
        <img src="image/wedding5.jpg" alt="Wedding Celebration 5" class="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-500">
        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div class="p-6 text-white w-full">
            <h3 class="text-lg font-semibold mb-2">Wedding Joy & Laughter</h3>
            <p class="text-sm opacity-90">Pure happiness captured</p>
            <div class="flex items-center mt-3">
              <i class="fas fa-heart text-red-400 mr-2"></i>
              <span class="text-sm">Wedding Celebration</span>
            </div>
      ...
      <!-- Wedding Photo 6 -->
      <div class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500">
        <img src="image/wedding6.jpg" alt="Wedding Celebration 6" class="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-500">
        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div class="p-6 text-white w-full">
            <h3 class="text-lg font-semibold mb-2">Perfect Wedding Memories</h3>
            <p class="text-sm opacity-90">Every detail preserved</p>
            <div class="flex items-center mt-3">
              <i class="fas fa-heart text-red-400 mr-2"></i>
              <span class="text-sm">Wedding Celebration</span>
            </div>
